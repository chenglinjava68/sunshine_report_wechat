package com.wechat.service.base.impl;
...
public abstract class BaseServiceImpl<T extends SuperVO> implements BaseService<T> {
    ...
    public PageInfo<T> queryPage(Map<String, Object> map, int pageNum, int pageSize) throws Exception {
        PageHelper.startPage(pageNum, pageSize);
        List<T> list = getBaseDao().selectList(map);
