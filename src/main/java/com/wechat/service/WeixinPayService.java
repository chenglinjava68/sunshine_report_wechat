...
import com.wechat.entity.UnifiedOrder;
import com.wechat.entity.UnifiedOrderReturn;
import com.wechat.sys.CommonConstant;
import com.wechat.util.ParaXml;
import com.wechat.util.WxUtil;
...
public class WeixinPayService {
	...
	public static UnifiedOrderReturn unifiedorder(UnifiedOrder uo) {
		...
		String sign = WxUtil.getSign(map, uo.getKey());
		...
		String reslutXml = WxUtil.xmlPost(CommonConstant.unifiedorderUrl, xml.toString());
